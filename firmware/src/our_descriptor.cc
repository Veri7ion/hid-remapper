...
uint8_t const our_report_descriptor_ps4[] = {
    ...
    0x09, 0x01,        //   Usage (Touch 1 ID)
    0x15, 0x00,        //   Logical Minimum (0)
    0x25, 0x7F,        //   Logical Maximum (127)
    0x75, 0x07,        //   Report Size (7)
    0x95, 0x01,        //   Report Count (1)
    0x81, 0x02,        //   Input (Data,Var,Abs,No Wrap,Linear,Preferred State,No Null Position)
    0x09, 0x02,        //   Usage (Touch 1 Not Touching)
    0x25, 0x01,        //   Logical Maximum (1)
    0x75, 0x01,        //   Report Size (1)
    0x81, 0x02,        //   Input (Data,Var,Abs,No Wrap,Linear,Preferred State,No Null Position)
    0x09, 0x03,        //   Usage (Touch 1 X)
    0x09, 0x04,        //   Usage (Touch 1 Y)
    0x26, 0xFF, 0x0F,  //   Logical Maximum (4095)
    0x75, 0x0C,        //   Report Size (12)
    0x95, 0x02,        //   Report Count (2)
    0x81, 0x02,        //   Input (Data,Var,Abs,No Wrap,Linear,Preferred State,No Null Position)
    0x09, 0x05,        //   Usage (Touch 2 ID)
    0x25, 0x7F,        //   Logical Maximum (127)
    0x75, 0x07,        //   Report Size (7)
    0x95, 0x01,        //   Report Count (1)
    0x81, 0x02,        //   Input (Data,Var,Abs,No Wrap,Linear,Preferred State,No Null Position)
    0x09, 0x06,        //   Usage (Touch 2 Not Touching)
    0x25, 0x01,        //   Logical Maximum (1)
    0x75, 0x01,        //   Report Size (1)
    0x81, 0x02,        //   Input (Data,Var,Abs,No Wrap,Linear,Preferred State,No Null Position)
    0x09, 0x07,        //   Usage (Touch 2 X)
    0x09, 0x08,        //   Usage (Touch 2 Y)
    0x26, 0xFF, 0x0F,  //   Logical Maximum (4095)
    0x75, 0x0C,        //   Report Size (12)
    0x95, 0x02,        //   Report Count (2)
    0x81, 0x02,        //   Input (Data,Var,Abs,No Wrap,Linear,Preferred State,No Null Position)
